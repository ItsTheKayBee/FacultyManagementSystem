...
if ($row["P1"] == "FALSE") {
    header('Location:EditProfile.php?parameter=' . $arg . '');
}
...
if (isset($_POST["submitpersonal"])) {
    ...
    if ($flag != 1) {
        ...
        if ($result = $conn->query($sql)) {
            header('Location:EditProfile.php?parameter=' . $arg . '#section1');
        } else {
...
if (isset($_POST["submitacademic1"])) {
    ...
    if ($result = $conn->query($sql))
        header('Location:EditHomePage.php#hscnew');
    else
        echo "<script type='text/javascript'>alert('" . mysqli_error($conn) . "');</script>";
}
if (isset($_POST["submitacademic2"])) {
    ...
    if ($result = $conn->query($sql))
        header('Location:EditHomePage.php#degree');
    else
        echo "<script type='text/javascript'>alert('" . mysqli_error($conn) . "');</script>";
}
...
if (isset($_POST["submitacademic3"])) {
    ...
    if ($result = $conn->query($sql))
        header('Location:EditHomePage.php#masters');
    else
        echo "<script type='text/javascript'>alert('" . mysqli_error($conn) . "');</script>";
}
...
if (isset($_POST["submitacademic4"])) {
    ...
    if ($result = $conn->query($sql))
        header('Location:EditHomePage.php#phd');
    else
        echo "<script type='text/javascript'>alert('" . mysqli_error($conn) . "');</script>";
}
...
if (isset($_POST["submitacademic5"])) {
    ...
    if ($result = $conn->query($sql))
        header('Location:EditProfile.php?parameter=' . $arg . '#section2');
    else
        echo "<script type='text/javascript'>alert('" . mysqli_error($conn) . "');</script>";
}
...
if (isset($_POST["submit_award"])) {
    ...
    if ($flagawd == 0) {
        ...
        if ($conn->query($award_query) == true) {
            header('Location:EditProfile.php?parameter=' . $arg . '#awards');
        } else {
            echo "<script type='text/javascript'>alert('" . mysqli_error($conn) . "');</script>";
        }
    }
