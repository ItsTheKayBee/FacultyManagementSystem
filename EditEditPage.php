        ...
        <form method="POST" onsubmit="return validateConf()" name="publicationconf" enctype="multipart/form-data">
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Date of Publication: </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')" value = "<?php echo dateformatChanger($date); ?>"onblur="(this.type='text')" <?php if(!empty($err[35])) echo "style='bord1er-color:red;' autofocus"; ?> id ="pubdateid" class="form-control" name="pubdate" placeholder="* Date of Publication">
    ...
    <div id ="section52" class="well">
        <form onsubmit="return sttpo()" method="POST" name="sttporganised">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
						<?php echo "<a href = 'EditProfile.php?parameter=".$arg."#section52'><font size='4'><span class='glyphicon glyphicon-arrow-left'></span>&nbspGo Back</font></a>";?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                        <h2>STTP</h2>
                    </div>
    ...
    <div id ="section53" class="well">
        <form action="" method="POST" onsubmit="return validateDeli()" name="sttpdelivered">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
						<?php echo "<a href = 'EditProfile.php?parameter=".$arg."#section53'><font size='4'><span class='glyphicon glyphicon-arrow-left'></span>&nbspGo Back</font></a>";?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                        <h2>STTP</h2>
                    </div>
