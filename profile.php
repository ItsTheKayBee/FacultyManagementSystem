            ...
            <div class="modal-body">
                <center>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <input type="file" class="proimg" name="image" id="image" accept="image/x-png,image/jpeg"
                               style="font-size:15px;">
                        <br><br>
                        <input type="submit" name="submitprofile" id="insert_profile" value="Save Changes"
...
<div class="container-fluid">
    <div class="col-sm-9 col-lg-10 col-md-8 col-xs-9" style="padding-left:40px; padding-right:0;">
        <div id="section1">
            <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12">
                <div class="col-sm-8 col-lg-8 col-md-8 col-xs-8">
                    <h1>Personal details <a href="homepage.php#section1"><span class="glyphicon glyphicon-edit"></span></a>
                    </h1>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td>Name:</td>
                                <td><?php if (!($name == '')) echo "<b>$name</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>

                            <tr>
                                <td>Gender:</td>
                                <td><?php if (!($gender == 'null')) echo "<b>$gender</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>

                            <tr>
                                <td>Email:</td>
                                <td><?php if (!($email == '')) echo "<b>$email</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>

                            <tr>
                                <td>Contact no:</td>
                                <td><?php if (!($contact == '')) echo "<b>$contact</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>

                            <tr>
                                <td>Date of Birth:</td>
                                <td><?php if (!($dob == '1950-01-01'))
                                        echo "<b>" . dateformatChanger($dob) . "</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>

                            <tr>
                                <td>Address:</td>
                                <td><?php if (!($address == '')) echo "<b>$address</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>

                            <tr>
                                <td>Joining Position:</td>
                                <td><?php if (!($join_pos == '')) echo "<b>" . $join_pos . "</b>"; else echo "<b>-<b>"; ?>
                                    <br></td>
                            </tr>

                            <tr>
                                <td>Joining Date:</td>
                                <td><?php if (!($join_date == '1950-01-01')) echo "<b>" . dateformatChanger($join_date) . "</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>
                            <?php
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td>Promotion :</td>
                                <td><?php if (!($pro1 == '')) echo "<b>$pro1</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>
                            <tr>
                                <td>Effective From:</td>
                                <td><?php if (!($pro1_date == '1950-01-01')) echo "<b>" . dateformatChanger($pro1_date) . "</b>"; else echo "<b>-<b>"; ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-4">
                    <div class="profile-img" id="section00">
                        <a href="#" id="chngpropic" class="btn btn-sm editimgbtn" style="float:right;"
                           data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-edit"></span></a>
                        <center>
                            <div class="thumbnail img-responsive" style="height:100%; width:80%;">
        ...
        <div id="section3">
            <legend><h1>Courses Taught<a href="homepage.php#section3"><span id="gly"
