    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <div class="dropdown">
                        <button id="setbtn" class="btn btn-primary" data-toggle="dropdown"><span
                                    class="glyphicon glyphicon-cog"></span></button>
                        <ul class="dropdown-menu">
                            <li><a href="security.php"><font style="color:black;">Forgot Password</font></a></li>
                            <li class="divider"></li>
                            <li><a href="logout.php"><font style="color:black;">Log out &nbsp <span
                                                class="glyphicon glyphicon-log-in"></span></font></a></li>
                        </ul>
                    </div>
                </li>
            </ul>
...
<nav class="col-sm-3 col-lg-3 col-md-4 col-xs-3" id="myScrollspy">
    <ul class="nav nav-pills nav-stacked"
        style="background-color: #F7F7F7; border-radius :7px; border:0.4px solid light-grey; padding:10px">
        <li class="dropdown" id="section0"><a href="EditProfile.php?parameter=<?php echo $arg; ?>">
        ...
        <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="Short Term Training Program">STTP<span
                        class="caret"></span></a>
            <ul class="dropdown-menu">
...
<center>
        ...
        <div class="col-sm-9 col-lg-9 col-md-8 col-xs-9">
                    ...
                    <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10  well">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-lg-6 col-xs-11">
                                    <input type="text" class="form-control" name="name"
                                           id="n" <?php if ($name == '') echo "placeholder='* Name'"; else echo "value='$name'"; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                                    <input type="radio" value="Male" name="gender"
                                           id="g" <?php if ($gender == 'Male') echo 'checked'; ?>>Male &nbsp
                                    <input type="radio" value="Female"
                                           name="gender" <?php if ($gender == 'Female') echo 'checked'; ?>>Female &nbsp
                                    <input type="radio" value="Other"
                                           name="gender" <?php if ($gender == 'Other') echo 'checked'; ?>>Other<br>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                                    <input type="text" <?php if (!empty($err[0])) echo "style='border-color:red;' autofocus"; ?>
                                           placeholder="* Email" class="form-control" id="e"
                                           name="email"<?php if ($email == '') echo "placeholder='* Email'"; else echo "value='$email'"; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                                    <input type="phone"
                                           class="form-control" <?php if (!empty($err[1])) echo "style='border-color:red;' autofocus"; ?>
                                           id="c"
                                           name="contact" <?php if ($contact == '') echo "placeholder='* Contact'"; else echo "value='$contact'"; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                                    <input id="d" <?php if (!empty($err[28])) echo "style='border-color:red;' autofocus"; ?>
                                           min="1950-01-01"
                                           max="<?php echo $maxdate; ?>" <?php if ($dob == '1950-01-01') echo "placeholder='* Date Of Birth'"; else echo "value = '" . dateformatChanger($dob) . "'"; ?>
                                           class="form-control" type="text" name="date" onfocus="(this.type='date')"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                                    <textarea id="a" class="form-control" rows="5"
                                              name="address" <?php if ($address == '') echo "placeholder='* Address'"; ?>><?php if (!($address == '')) echo $address; ?></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                                    <input id="pass" type="text"
                                           class="form-control" <?php if (!($join_pos == '')) echo "value='$join_pos'"; else echo 'placeholder="Joining Position"'; ?>
                                           name="joining_position"> &nbsp &nbsp
                                </div>
                            </div>
                            <br><br><br>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                                    <input <?php if (!empty($err[27])) echo "style='border-color:red;' autofocus";
                                    if ($join_date == '1950-01-01') echo "placeholder='Date Of Joining'"; else echo "value ='" . dateformatChanger($join_date) . "'"; ?>
                                            class="form-control" type="text" onfocus="(this.type='date')"
                                            onblur="(this.type='text')" name="joining_date">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                    <select class="form-control" name="pro1" id="pass">
                        ...
                        <option value="Head Of Department" <?php if ($pro1 == "Head Of Department") echo "selected" ?> >
                            Head Of Department
                        </option>
                        <option value="Associate Professor" <?php if ($pro1 == "Associate Professor") echo "selected" ?> >
                            Associate Professor
                        </option>
                        <option value="Lab Assistant" <?php if ($pro1 == "Lab Assistant") echo "selected" ?> >Lab
                            Assistant
                        </option>
                        <option value="Visiting Faculty" <?php if ($pro1 == "Visiting Faculty") echo "selected" ?> >
                            Visiting Faculty
                        </option>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                    ...
                    else echo "value = " . dateformatChanger($pro1_date); ?> class="form-control"
            ...
            <br><br><br>
            <div class="form-group">
                <input type="submit" style="color:white;" class="btn btn-primary btn-md" value="Submit"
                       name="submitpersonal">
            </div>
            </fieldset>
            </form>
            ...
            <form method="POST" onsubmit="return ac1()" name="a1" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" class="form-control" name="sscinstitute"
                                   id="sscinstitute_id" <?php if ($sscInstitute == '') echo "placeholder='* Institute Name'"; else echo "value='$sscInstitute'"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="number" class="form-control" name="sscmarks" id="sscmarks_id" min="0" max="100"
                                   step="0.01" <?php if ($sscPercentile == 0) echo "placeholder='* Percentile'"; else echo "value=$sscPercentile"; ?> >
                    ...
                    <div class="form-group">
                        <input type="submit" style="color:white;"
                               class="btn btn-primary btn-md" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
                               value="Submit" name="submitacademic1">
                    </div>
            </form>
            ...
            <div id="hscnew">
                ...
                <form method="POST" onsubmit="return ac2()" name="a2" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" name="hscinstitute" id="hscinstitute_id"
                                   class="form-control" <?php if ($hscInstitute == '') echo "placeholder='* Institute Name'"; else echo "value='$hscInstitute'"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="number" class="form-control" name="hscmarks" id="hscmarks_id" min="0" max="100"
                                   step="0.01" <?php if ($hscPercentile == 0) echo "placeholder='* Percentile'"; else echo "value=$hscPercentile"; ?> >
                    ...
                    <br><br><br><br><br><br>
                    <div class="form-group">
                        <input type="submit" style="color:white;" class="btn btn-primary btn-md"
                               value="Submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
                               name="submitacademic2">
                    </div>
            ...
            <div id="degree">
                ...
                <form method="POST" onsubmit="return ac3()" name="a3" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" name="btechinstitute" id="btechinstitute_id"
                                   class="form-control" <?php if ($bachelorsInstitute == '') echo "placeholder='* Institute Name'"; else echo "value='$bachelorsInstitute'"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="number" name="btechmarks" id="btechmarks_id" class="form-control" min="0"
                                   max="10"
                                   step="0.01" <?php if ($bachelorsPercentile == 0) echo "placeholder='* CGPA'"; else echo "value=$bachelorsPercentile"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <select id="sel1" class="form-control" name="btechdegree">
                                ...
                                <option value='Information Technology' <?php if ($bachelorsIn == 'Information Technology') echo "selected"; ?> >
                                    Information Technology Engineering
                                </option>
                                <option value='Computer Science Engineering' <?php if ($bachelorsIn == 'Computer Science Engineering') echo "selected"; ?> >
                                    Computer Science Engineering
                                </option>
                                <option value='Electronics and Telecommunication Engineering' <?php if ($bachelorsIn == 'Electronics and Telecommunication Engineering') echo "selected"; ?> >
                                    Electronics and Telecommunication Engineering
                                </option>
                                <option value='Electronics' <?php if ($bachelorsIn == 'Electronics') echo "selected"; ?> >
                                    Electronics
                                </option>
                    ...
                    <br><br><br><br><br><br>
                    <div class="form-group">
                        <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
                               style="color:white;" class="btn btn-primary btn-md" value="Submit"
                               name="submitacademic3">
                    </div>
                </form>
            </div>
            ...
            <div id="masters">
                <form method="POST" onsubmit="return ac4()" name="a4" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" name="mtechinstitute" id="mtechinstitute_id"
                                   class="form-control" <?php if ($mastersInstitute == '') echo "placeholder='* Institute Name'"; else echo "value='$mastersInstitute'"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="number" name="mtechmarks" id="mtechmarks_id" class="form-control" min="0"
                                   max="10"
                                   step="0.01" <?php if ($mastersPercentile == 0) echo "placeholder='* CGPA'"; else echo "value=$mastersPercentile"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <select id="sel2" name="mtechdegree" class="form-control">
                                ...
                                <option value='Computer Science Engineering' <?php if ($mastersIn == 'Computer Science Engineering') echo "selected"; ?> >
                                    Computer Science Engineering
                                </option>
                                <option value='Computer Engineering' <?php if ($mastersIn == 'Computer Engineering') echo "selected"; ?> >
                                    Computer Engineering
                                </option>
                                <option value='Embedded System & Computer Engineering' <?php if ($mastersIn == 'Embedded System & Computer Engineering') echo "selected"; ?> >
                                    Embedded System & Computing Engineering
                                </option>
                                <option value='Electronics' <?php if ($mastersIn == 'Electronics') echo "selected"; ?> >
                                    Electronics
                                </option>
            ...
            <div id="phd">
                <form method="POST" onsubmit="return ac5()" name="a5" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" class="form-control" name="phdinstitute"
                                   id="phdinstitute_id" <?php if ($phdInstitute == '') echo "placeholder='* Institute Name'"; else echo "value='$phdInstitute'"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="number" name="phdmarks" id="phdmarks_id" class="form-control" min="0" max="10"
                                   step="0.01" <?php if ($phdPercentile == 0) echo "placeholder='* CGPA'"; else echo "value=$phdPercentile"; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <select id="sel3" name="phddegree" class="form-control">
                                ...
                                <option value='Electronics' <?php if ($phdIn == 'Electronics') echo "selected"; ?> >
                                    Electronics
                                </option>
            ...
            <form method="post" onsubmit="return coursesvalidation()" name="coursestaught">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="file" name="changeName_certificate_image" id="changeName_certificate_image"
    ...
    <div class="form-group">
        <input type="submit"
               type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
               style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitcourses">
    </div>
    </form>
    </div>
    </div>
        ...
        <div id="section4">
            <form method="POST" name="project" onsubmit="return projguided()" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" name="projtitle" id="projtitleid"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-8 col-xs-6">
                        <div class="col-md-7 col-sm-7 col-lg-7 col-xs-8">
                            <label class="radio-inline"><input type="radio" name="projtype" checked value="BEPROJECT"
                                                               onclick="var input = document.getElementById('name2'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}">B.E
                                Project</label>
                            <label class="radio-inline"><input type="radio" name="projtype" value="Internship"
                                                               onclick="var input = document.getElementById('name2'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}">Internship</label>
                            <label class="radio-inline"><input type="radio" name="projtype" for="name2"
                                                               onclick="var input = document.getElementById('name2'); if(this.checked){ input.disabled = false; input.focus();}else{input.disabled=true;}">Other</label>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" name="projdesc" id="projdescid"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="projstud1name" id="projstud1nameid">
                                    <span class="error" id="projstud1name"></span></td>
                                </td>
                                <td><input type="number" max="9999999" class="form-control" name="projstud1roll"
                                           id="projstud1rollid">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="projstud2name" id="projstud2nameid">
                                    <span class="error" id="projstud2name"></span></td>
                                </td>
                                <td><input type="number" max="9999999" class="form-control" name="projstud2roll"
                                           id="projstud2rollid">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="projstud3name" id="projstud3nameid">
                                    <span class="error" id="projstud3name"></span></td>
                                </td>
                                <td><input type="number" max="9999999" class="form-control" name="projstud3roll"
                                           id="projstud3rollid">
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="projstud4name" id="projstud4nameid">
                                    <span class="error" id="projstud4name"></span></td>
                                </td>
                                <td><input type="number" max="9999999" class="form-control" name="projstud4roll"
                                           id="projstud4rollid">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Attachment : </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="file" name="proj_certificate_image" id="proj_certificate_image"
                               accept="application/pdf"/>
                    </div>
                </div>
                <br><br>
    ...
    <div class="form-group">
        <!-- SUBMIT -->
        <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
               style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitprojects">
    </div>
    </form>
    </div>
    </div>
    ...
    <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10 well">
        <div id="section41">
            <form method="POST" name="publicationbooks" onsubmit="return validateBook()" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" name="bookname" id="booknameid"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" name="bookisbn" id="bookisbnid"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')"
                               onblur="(this.type='text')" <?php if (!empty($err[33])) echo "style='border-color:red;' autofocus"; ?>
                               id="pubdateid" class="form-control" name="pubdate" placeholder="* Date of Publication">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" class="form-control" name="book_pub_name" id="book_pub_nameid"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" class="form-control" name="book_auth_name" id="book_auth_nameid"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="bookauthinst" class="form-control" name="book_auth_inst"
                                   placeholder="Author's Institute">
                        </div>
                    </div>
                    <br><br><br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="bookcoauthname1" class="form-control" name="book_coauth_name1"
                                   placeholder="Name">
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="bookcoauthinst1" class="form-control" name="book_coauth_inst1"
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Name: </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="bookcoauthname2" class="form-control" name="book_coauth_name2"
                                   placeholder="Name">
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Institute: </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="bookcoauthinst2" class="form-control" name="book_coauth_inst2"
                                   placeholder="Institute">
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Name: </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="bookcoauthname3" class="form-control" name="book_coauth_name3"
                                   placeholder="Name">
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Institute: </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="bookcoauthinst3" class="form-control" name="book_coauth_inst3"
                                   placeholder="Institute">
                        </div>
                    </div>
                    <br><br>
        ...
        <div class="form-group">
            <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
                   style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitpublicationbooks">
        </div>
        </form>
    </div>
    </div>
    ...
    <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10 well">
        <div id="section42">
            <form method="post" action="" name="publicationjournal" onsubmit="return validateJour()"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id="journaltitleid" class="form-control" name="journal_title"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" name="journal_name" id="journal_nameid"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <label class="radio-inline"><input type="radio" value="YES" name="journal_fauth" checked
                                                           onclick="var input = document.getElementById('journal_fauth'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}">YES</label>
                        <label class="radio-inline"><input type="radio" value="NO" name="journal_fauth"
                                                           for="journal_fauth"
                                                           onclick="var input = document.getElementById('journal_fauth'); if(this.checked){ input.disabled = false; input.focus();}else{input.disabled=true;}">NO</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="jourcoauthname1" class="form-control" name="jour_coauth_name1"
                           placeholder="* Co Author 1">
                    ...
                    <input type="text" id="jourcoauthnameaff1" class="form-control" name="jour_coauth_nameaff1"
                           placeholder="* Co Author 1 affiliation">
                ...
                <div class="form-group">
                    <input type="button" style="color:white;background-color: #3C2AE6;" class="btn"
                           value="Add co authors" id="addInput"/>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Publisher's Name: </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id="journal_pub_nameid" class="form-control" name="journal_pub_name"
                               placeholder="* Publisher's Name">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Date of Publication: </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')" <?php if (!empty($err[34])) echo "style='border-color:red;' autofocus"; ?>
                               onblur="(this.type='text')" id="jour_dateid" class="form-control" name="jour_date"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="number" id="journal_impactid" min="0" class="form-control" name="journal_impact"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" name="journal_vol" id="journal_volid" class="form-control"
                               placeholder="* Volume">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            ...
                            <label class="radio-inline"><input type="radio" name="journal_book" value="NO"
                                                               checked>No</label>
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" name="journal_issue" class="form-control" id="journal_issueid"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            ...
                            <label class="radio-inline"><input type="radio" name="journal_peer" value="NO"
                                                               checked>No</label>
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" name="journal_pg" id="journal_pgid" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" name="journal_issn" class="form-control" id="journal_issnid"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            ...
                            <label class="radio-inline"><input type="radio" name="journal_paid" value="NO"
                                                               checked>No</label>
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" name="journal_cite" id="journal_citeid" class="form-control"
                                   placeholder="* Citation Index">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            ...
                            <label class="radio-inline"><input type="radio" name="journal_sjr" value="NO"
                                                               checked>No</label>
                        </div>
                    </div>
                    <br><br><br>
        ...
        <div class="form-group">
            <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
                   style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitjournals">
        </div>
        </form>
    </div>
    </div>
    ...
    <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10 well">
        <div id="section43">
            <form method="POST" onsubmit="return validateConf()" name="publicationconf" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Name : </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id="conf_nameid" class="form-control" name="conf_name"
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Are you the first Author ?</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <label class="radio-inline"><input type="radio" name="conf_fauth" value="YES" checked
                                                           onclick="var input = document.getElementById('conf_fauth'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}">YES</label>
                        <label class="radio-inline"><input type="radio" name="conf_fauth" value="NO" for="conf_fauth"
                                                           onclick="var input = document.getElementById('conf_fauth'); if(this.checked){ input.disabled = false; input.focus();}else{input.disabled=true;}">NO</label>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3"> Co-Author Name : </label>
                    <input type="text" id="confcoauthname1" class="form-control" name="name1"
                           placeholder="* Co Author 1">
                    <span class="error" id="name1" style="color:red;"></span>
                    <br>
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3"> Co-Author Affiliation : </label>
                    <input type="text" id="confcoauthnameaff1" class="form-control" name="name1_affiliation"
                           placeholder="Co Author 1 affiliation">
                ...
                <div class="form-group">
                    <input type="button" style="color:white;" class="btn btn-primary btn-md" value="Add co authors"
                           id="addInputConf"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')"
                               onblur="(this.type='text')" <?php if (!empty($err[33])) echo "style='border-color:red;' autofocus"; ?>
                               id="confpubdateid" class="form-control" name="pubdate"
                               placeholder="* Date of Publication">
                        <span class="error" id="pubdate"><?php echo $err[33]; ?></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id="conf_hindexid" class="form-control" name="conf_hindex"
                               placeholder="* H index">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Publisher's Name: </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id="conf_pubnameid" class="form-control" name="conf_pubname"
                               placeholder="* Publisher's name">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id="conf_pronameid" class="form-control" name="conf_proname"
                               placeholder="* Proceding name">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id="conf_themeid" class="form-control" name="conf_themename"
                               placeholder="* Theme of conference">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            ...
                            <label class="radio-inline"><input type="radio" name="conf_paid" value="NO"
                                                               checked>NO</label>
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Page Number : </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="conf_pgid" class="form-control" name="conf_pg"
                                   placeholder="* Page number">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="conf_issnid" class="form-control" name="conf_issn"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="conf_orgid" class="form-control" name="conf_orgname"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="conf_placeid" class="form-control" name="conf_place"
                                   placeholder="* Venue">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            ...
                            <label class="radio-inline"><input type="radio" name="conf_pres" value="NO"
                                                               checked>NO</label>
                        </div>
                    </div>
                    <br><br><br>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            ...
                            <label class="radio-inline"><input type="radio" name="conf_web" value="NO"
                                                               checked>NO</label>
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Citation Index : </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="conf_citeid" class="form-control" name="conf_cite"
                                   placeholder="* Citation Index">
        ...
        <div class="form-group">
            <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
                   style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitconference">
        </div>
        </form>
    </div>
    </div>
    ...
    <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10 well">
        <div id="section51">
            <form method="POST" action="" name="sttpattended" onsubmit="return validateAttended()"
                  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" id="attendednameid" placeholder="* Name of the event"
                               name="attendedname">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <select class="form-control" name="eventtype" id="eventtype"
                                onchange="var input=document.getElementById('eventtype_new');if($('#eventtype :selected').text()=='Other'){input.disabled = false; input.focus();}else{input.disabled=true;}">
                        ...
                        <input id="eventtype_new" name="eventtype_new" placeholder="Enter Event Type" disabled
                               type="text"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* From" type="text"
                               onfocus="(this.type='date')" <?php if ((!empty($err[37])) || (!empty($err[38]))) echo "style='border-color:red;' autofocus"; ?>
                               onblur="(this.type='date')" id="datefromattendedid" class="form-control"
                               name="datefromattended">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* To" type="text"
                               onfocus="(this.type='date')" <?php if (!empty($err[38])) echo "style='border-color:red;' autofocus"; ?>
                               onblur="(this.type='date')" class="form-control" id="datetoattendedid"
                               name="datetoattended">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input name="durationattended" placeholder="Duration" class="form-control" type="text"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="number" name="participantsattended" class="form-control"
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Certificate : </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="file" name="certificateattended" id="certificateattended"
                               accept="application/pdf"/>
                    </div>
                </div>
                <br><br><br>
    ...
    <div class="form-group">
        <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
               style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitsttpattended">
    </div>
    </form>
    </div>
    </div>
        ...
        <div id="section52">
            <form onsubmit="return sttpo()" method="POST" name="sttporganised" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Event Name:</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" placeholder="* Name of the event" id="organizedname_id"
                               name="organizedname">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Event Type :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <select class="form-control" name="organizedeventtype" id="orgeventtype"
                                onchange="var input=document.getElementById('orgeventtype_new');if($('#orgeventtype :selected').text()=='Other'){input.disabled = false; input.focus();}else{input.disabled=true;}">
                            <option value="">* Event type</option>
                            <option value="Seminar">Seminar</option>
                            <option value="Training">Training</option>
                            <option value="Workshop">Workshop</option>
                        ...
                        <input id="orgeventtype_new" name="orgeventtype_new" placeholder="Enter Event Type" disabled
                               type="text"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* From" type="text"
                               onfocus="(this.type='date')" <?php if ((!empty($err[39])) || (!empty($err[40]))) echo "style='border-color:red;' autofocus"; ?>
                               onblur="(this.type='date')" class="form-control" id="datefromorganized_id"
                               name="datefromorganized">
                        <span class="error"
                              id="datefromorganized"><?php if (!empty($err[39])) echo $err[39]; ?></span><br>
                    </div>
                </div>
                <br><br><br>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* To" type="text"
                               onfocus="(this.type='date')" <?php if (!empty($err[40])) echo "style='border-color:red;' autofocus"; ?>
                               onblur="(this.type='date')" class="form-control" id="datetoorganized_id"
                               name="datetoorganized">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Total Participants :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="number" name="participantsorganized" class="form-control"
                               placeholder="Total Participants">
                    </div>
                </div>
                <br><br><br>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Certificate : </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="file" name="sttpo_certificate_image" id="sttpo_certificate_image"
                               accept="application/pdf"/>
                    </div>
                </div>
                <br><br>
    ...
    <div class="form-group">
        <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
               style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitsttporganized">
    </div>
    </form>
    </div>
    </div>
    ...
    <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10 well">
        <div id="section53">
            <form action="" method="POST" onsubmit="return validateDeli()" name="sttpdelivered"
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Event Name :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" placeholder="* Name of the event" id="deliverednameid"
                               name="deliveredname">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Event Type :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <select class="form-control" name="deliveredeventtype" id="deliveredeventtype"
                                onchange="var input=document.getElementById('deleventtype_new');if($('#deliveredeventtype :selected').text()==='Other'){input.disabled = false; input.focus();}else{input.disabled=true;}">
                            <option value="">* Event type</option>
                            <option value="Seminar">Seminar</option>
                            <option value="Training">Training</option>
                            <option value="Workshop">Workshop</option>
                        ...
                        <input id="deleventtype_new" name="deleventtype_new" placeholder="Enter Event Type" disabled
                               type="text"/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* From" type="text"
                               onfocus="(this.type='date')" <?php if ((!empty($err[41])) || (!empty($err[42]))) echo "style='border-color:red;' autofocus"; ?>
                               onblur="(this.type='date')" class="form-control" id="datefromdeliveredid"
                               name="datefromdelivered">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* To" type="text"
                               onfocus="(this.type='date')" <?php if (!empty($err[42])) echo "style='border-color:red;' autofocus"; ?>
                               onblur="(this.type='date')" class="form-control" id="datetodeliveredid"
                               name="datetodelivered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <textarea class="form-control" rows="5" placeholder="Activity description"
                                      class="form-control" name="activitydescription"></textarea>
                        </div>
                    </div>
                    <br><br><br><br><br><br><br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Duration :</label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input name="durationdelivered" placeholder="Duration" class="form-control" type="text"
                                   onfocus="(this.type='time')" onblur="(this.type='text')">
                        </div>
                    </div>
                    <br><br><br>
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Certificate : </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="file" name="sttpd_certificate_image" id="sttpd_certificate_image"
                                   accept="application/pdf"/>
                        </div>
                    </div>
                    <br><br>
        ...
        <div class="form-group">
            <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
                   style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitsttpdelivered">
        </div>
        </form>
    </div>
    </div>
            ...
            <form method="POST" onsubmit="return co()" name="co6" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" class="form-control" placeholder="* Name of the Activity"
                                   name="cocurrname" id="cocurrname_id">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <textarea id="cocurdesc" class="form-control" name="cocurrdescription" cols="50" rows="6"
                                      placeholder="Description of Co-Curricular Activity"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input onfocus="(this.type='date')" <?php if (!empty($err[43])) echo "style='border-color:red;' autofocus"; ?>
                                   onblur="(this.type='text')" class="form-control" name="cocurrdate" id="cocurrdate_id"
                                   placeholder="* Date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-7 col-xs-6">
                            <div class="col-md-6 col-sm-9 col-lg-7 col-xs-6">
                                <label class="radio-inline"><input type="radio" name="cocurrtype" checked
                                                                   onclick="var input = document.getElementById('name22'); if(this.checked){ input.disabled = true; input.focus();}else{input.disabled=false;}">K.
                                    J. Somaiya (InHouse)</label>

                                <label class="radio-inline"><input type="radio" name="cocurrtype" for="name2"
                                                                   onclick="var input = document.getElementById('name22'); if(this.checked){ input.disabled = false; input.focus();}else{input.disabled=true;}">Other</label>
                            </div>
    ...
    <div class="form-group">
        <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
               style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitcocurricular">
    </div>
    </fieldset>
    </form>
    </div>
            ...
            <form method="POST" onsubmit="return extra()" name="ext7" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Description:</label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <textarea id="extradesc" class="form-control" name="extradescription" cols="50" rows="6"
                                      placeholder="Description of Activity"></textarea>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Date :</label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input onfocus="(this.type='date')" <?php if (!empty($err[44])) echo "style='border-color:red;' autofocus"; ?>
                                   onblur="(this.type='text')" class="form-control" name="extradate"
                                   placeholder="* Date" id="extradate1">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Location :</label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="extplace" class="form-control" name="extraplace"
    ...
    <div class="form-group">
        <input type="submit" <?php if ($gender == 'null') echo "disabled title='Please fill Personal details first'" ?>
               style="color:white;" class="btn btn-primary btn-md" value="Submit" name="submitextra">
    </div>
    </fieldset>
    </form>
    </div>
            ...
            <form method="POST" action="" onsubmit="return awards()" name="awards_form" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" class="form-control" placeholder="* Title of the Award/Achievement"
                                   name="award_name" id="award_name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input onfocus="(this.type='date')" <?php if (!empty($err[44])) echo "style='border-color:red;' autofocus"; ?>
                                   onblur="(this.type='date')" class="form-control" name="award_date"
                                   placeholder="* Honour Date" id="award_date">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="text" id="award_issuer" class="form-control" name="award_issuer"
                                   placeholder="* Issuer">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Description:</label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <textarea id="award_desc" class="form-control" name="award_description" cols="50" rows="6"
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Certificate : </label>
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input type="file" name="award_certificate_image" id="award_certificate_image"
                                   accept="application/pdf"/>
                        </div>
                    </div>
                    <br><br>
