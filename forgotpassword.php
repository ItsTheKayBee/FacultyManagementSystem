...
<body>
	<div class="container">
		<form style="background-color:white;" method="post" id ="forgot-form" autocomplete="off" method="post" class="login-wrap login-html login-form sign-up-htm" name="forgotpwd-form" onsubmit="return validateForm()">
			<center>
