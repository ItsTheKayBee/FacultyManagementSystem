                ...
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section3" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
        ...
        <div id ="section4" class="well">
            <form method="POST" name="project" onsubmit="return projguided()" enctype="multipart/form-data">
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section4" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
        ...
        <div id ="section41" class="well">
            <form method="POST"  name="publicationbooks" onsubmit="return validateBook()" enctype="multipart/form-data">
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section41" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                            <h2>Publications</h2>
                        </div>
        ...
        <div id = "section42" class="well">
            <form method="post" action="" name="publicationjournal" onsubmit="return validateJour()" enctype="multipart/form-data" >
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section42" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                            <h2>Publications</h2>
                        </div>
        ...
        <div id ="section43" class="well">
            <form method="POST" onsubmit="return validateConf()" name="publicationconf" enctype="multipart/form-data">
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section43" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                            <h2>Publications</h2>
                        </div>
        ...
        <div id ="section51" class="well">
            <form method="POST" action="" name="sttpattended" onsubmit="return validateAttended()"  enctype="multipart/form-data">
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section51" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                            <h2>STTP</h2>
                        </div>
        ...
        <div id ="section52" class="well">
            <form onsubmit="return sttpo()" method="POST" name="sttporganised">
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section52" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                            <h2>STTP</h2>
                        </div>
        ...
        <div id ="section6" class="well">
            <form method="POST" onsubmit="return co()" name="co6">
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section6" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
        ...
        <div id ="section7" class="well">
            <form method="POST" onsubmit="return extra()" name="ext7">
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section7" title="Obviously not Simon! :P"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
            ...
            <form method="POST" onsubmit="return awards()" name="awards_form" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                            <input value = <?php echo $award_date; ?> onfocus="(this.type='date')" <?php if(!empty($err[11])) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" class="form-control" name="award_date" placeholder="* Date" id ="award_date">
