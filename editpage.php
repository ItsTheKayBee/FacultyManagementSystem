                ...
                <fieldset>
                    <legend>
                        <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                            <a href = "profile.php#section3"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                        </div>
    ...
    <div id ="section4" class="well">
        <form method="POST" name="project" onsubmit="return projguided()" enctype="multipart/form-data">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section4"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
    ...
    <div id ="section41" class="well">
        <form method="POST"  name="publicationbooks" onsubmit="return validateBook()" enctype="multipart/form-data">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section41"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                        <h2>Publications</h2>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')" onblur="(this.type='text')" <?php if(!empty($err[3])) echo "autofocus"; ?> id ="pubdateid" value = "<?php echo dateformatChanger($datepub); ?>" class="form-control" name="pubdate" placeholder="Date of Publication">
    ...
    <div id = "section42" class="well">
        <form method="post" action="" name="publicationjournal" onsubmit="return validateJour()" enctype="multipart/form-data" >
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section42"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                        <h2>Publications</h2>
                    </div>
                ...
                <div class="form-group">
                    <input type="button" style="color:white;" <?php if($count==10) echo "disabled title='Can add only 10 co authors'"?>
                           class="btn btn-primary btn-md" value="Add co authors" id ="addInput" />
                    <input type="button" style="color:white;"  class="btn btn-primary btn-md" value="Remove"  id="rem" />
                    <br>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Date of Publication: </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')" value = "<?php echo dateformatChanger($date); ?>" <?php if(!empty($err[34])) echo "style='border-color:red;' autofocus"; ?> onblur="(this.type='text')" id ="jour_dateid" class="form-control" name="jour_date" placeholder="* Date of Publication">
    ...
    <div id ="section43" class="well">
        <form method="POST" onsubmit="return validateConf()" name="publicationconf" enctype="multipart/form-data">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section43"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                        <h2>Publications</h2>
                    </div>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Name : </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id ="conf_nameid" class="form-control" name="conf_name" value = "<?php echo $confname; ?>" placeholder="* Conference Name">
                ...
                <div class="form-group">
                    ...
                    <input type="button" style="color:white;"  class="btn btn-primary btn-md" value="Remove"  id="remc" />
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Date of Publication: </label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')" value = "<?php echo dateformatChanger($date); ?>"onblur="(this.type='text')" <?php if(!empty($err[35])) echo "style='border-color:red;' autofocus"; ?> id ="pubdateid" class="form-control" name="pubdate" placeholder="* Date of Publication">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <label class="radio-inline"><input type="radio"  name="conf_poster" value="Poster" <?php  if($poster=="Poster") echo "checked"; ?> >Poster</label>
                        <label class="radio-inline"><input type="radio"  name="conf_poster" value="Oral" <?php if($poster=="Oral") echo "checked"; ?> >Oral</label>
    ...
    <div id ="section51" class="well">
        <form method="POST" action="" name="sttpattended" onsubmit="return validateAttended()"  enctype="multipart/form-data">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section51"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                        <h2>STTP</h2>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <select class="form-control" name="eventtype" id="eventtype" onchange="var input=document.getElementById('eventtype_new');if($('#eventtype :selected').text()=='Other'){input.disabled = false; input.focus();}else{input.disabled=true;}">
                            ...
                            <option value="Other" <?php if($eventtype != "Seminar" && $eventtype != "Training" && $eventtype != "Workshop" ) echo 'selected'; ?>>Other</option>
                        </select><br>
                        <input id ="eventtype_new" name="eventtype_new" placeholder="Enter Event Type" <?php if($eventtype != "Seminar" && $eventtype != "Training" && $eventtype != "Workshop" ) echo 'value="'.$eventtype.'"'; else echo 'disabled'?> type="text"/><br>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* From" value = '<?php echo dateformatChanger($datefrom); ?>' type="text" onfocus="(this.type='date')" <?php if((!empty($err[4])) || (!empty($err[5]))) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" id ="datefromattendedid" class="form-control" name="datefromattended">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* To" value = '<?php echo dateformatChanger($dateto); ?>' type="text" onfocus="(this.type='date')" <?php if(!empty($err[5])) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" class="form-control" id ="datetoattendedid" name="datetoattended">
    ...
    <div id ="section52" class="well">
        <form onsubmit="return sttpo()" method="POST" name="sttporganised">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section52"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                        <h2>STTP</h2>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <select class="form-control" name="organizedeventtype" id="orgeventtype" onchange="var input=document.getElementById('orgeventtype_new');if($('#orgeventtype :selected').text()=='Other'){input.disabled = false; input.focus();}else{input.disabled=true;}">
                            ...
                            <option value="Other"  <?php if($type != "Seminar" && $type != "Training" && $type != "Workshop" ) echo 'selected'; ?> >Other</option>
                        </select><br>
                        <input id ="orgeventtype_new" name="orgeventtype_new" placeholder="Enter Event Type" <?php if($type != "Seminar" && $type != "Training" && $type != "Workshop" ) echo 'value="'.$type.'"'; else echo 'disabled'?>  type="text"/>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">From :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* From" value = "<?php echo dateformatChanger($datefrom); ?>" type="text" onfocus="(this.type='date')" <?php if((!empty($err[6])) || (!empty($err[7]))) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" class="form-control" id ="datefromorganized_id" name="datefromorganized">
                        <span class="error" id ="datefromorganized"><?php if(!empty($err[6])) echo $err[6];?></span></div></div>
                <br><br><br>
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">To :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* To" value = "<?php echo dateformatChanger($dateto); ?>" type="text" onfocus="(this.type='date')" <?php if(!empty($err[7])) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" class="form-control" id ="datetoorganized_id" name="datetoorganized">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        ...
                        <input id ="deleventtype_new" name="deleventtype_new" placeholder="Enter Event Type" <?php if($eventtype != "Seminar" && $eventtype != "Training" && $eventtype != "Workshop" ) echo 'value="'.$eventtype.'"'; else echo 'disabled'?> type="text"/>
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">From :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* From"  value = "<?php echo dateformatChanger($datefrom); ?>" type="text" onfocus="(this.type='date')" <?php if((!empty($err[8])) || (!empty($err[9]))) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" class="form-control" id ="datefromdeliveredid" name="datefromdelivered">
                        <span class="error" id ="datefromdelivered" ><?php if(!empty($err[8])) echo $err[8];?></span></div></div><br><br><br>
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">To :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input placeholder="* To"  value = "<?php echo dateformatChanger($dateto); ?>" type="text" onfocus="(this.type='date')" <?php if(!empty($err[9])) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')"class="form-control" id ="datetodeliveredid" name="datetodelivered" >
    ...
    <div id ="section6" class="well">
        <form method="POST" onsubmit="return co()" name="co6">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section6"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <textarea id ="cocurdesc" class="form-control" name="cocurrdescription" cols="50" rows="6" placeholder="Description of Co-Curricular Activity"><?php echo $description; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input onfocus="(this.type='date')" <?php if(!empty($err[10])) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" value = "<?php echo dateformatChanger($date); ?>" class="form-control" name="cocurrdate" id ="cocurrdate_id" placeholder="* Date">
    ...
    <div id ="section7" class="well">
        <form method="POST" onsubmit="return extra()" name="ext7">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#section7"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Date :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input value = <?php echo dateformatChanger($date); ?> onfocus="(this.type='date')" <?php if(!empty($err[11])) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" class="form-control" name="extradate" placeholder="* Date" id ="extradate1">
    ...
    <div id ="awards" class="well">
        <form method="POST" onsubmit="return awards()" name="awards_form" enctype="multipart/form-data">
            <fieldset>
                <legend>
                    <div class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                        <a href = "profile.php#awards"><font size="4"><span class="glyphicon glyphicon-arrow-left"></span>&nbspGo Back</font></a>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Award Title :</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" class="form-control" placeholder="* Title of the Award" name = "award_name" value = "<?php echo $award_name; ?>" id ="award_name">
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Description:</label>
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <textarea id ="award_desc" class="form-control" name="award_desc" cols="50" rows="6" placeholder="Description"><?php echo $award_desc ;?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input value = "<?php echo dateformatChanger($award_date); ?>" onfocus="(this.type='date')" <?php if(!empty($err[11])) echo "style='border-color:red;' autofocus";?> onblur="(this.type='text')" class="form-control" name="award_date" placeholder="* Date" id ="award_date">
                        <span class="error" id ="awddate"><?php if(!empty($err[11])) echo $err[11];?></span>
                        <br>
                    </div></div>
                <br><br><br>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-9 col-lg-6 col-xs-6">
                        <input type="text" id ="awdissuer" class="form-control" value = "<?php echo $award_issuer; ?>" name="award_issuer" placeholder="* Issuer">
                    </div></div>
                <br><br><br>
                <div class="form-group">
                    <label class="col-sm-3 col-md-3 col-lg-3 col-xs-3">Certificate :</label>
