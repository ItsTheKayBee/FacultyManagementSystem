...
<head>
    ...
    <style>
        ...
        @media screen and (max-width:1100px) {
            #section00, #section1, #section2, #section3, #section41, #section42 ,#section43, #section51, #section52, #section53 , #section6 , #section7,#awards {
                margin-left:100px;
            }
        }
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id ="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li><a style="color:white" href="CV.php?parameter=<?php echo $arg; ?>" class="somenav">Generate CV</a></li>
                <li>
                    <div class="dropdown">
                        <button class="btn btn-primary" id ="setbtn" data-toggle="dropdown"><span class="glyphicon glyphicon-cog"></span></button>
...
<nav class="col-sm-3 col-lg-2 col-md-4 col-xs-3" id ="myScrollspy">
    <ul class="nav nav-pills nav-stacked" style="background-color: #F7F7F7; border-radius :7px; border:0.4px solid lightgray; padding:10px">
        ...
        <hr>
        <li id ="sectionA" class="lihover"><a href="#section1">Personal Details</a></li>
        <li id ="sectionB" class="lihover"><a href="#section2">Academic Qualifications</a></li>
        <li id ="sectionC" class="lihover"><a href="#section3">Courses Taught</a></li>
        <li id ="sectionH" class="lihover"><a href="#section4">Projects Guided</a></li>
        <li id ="sectionD" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Publications <span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li id ="sectionD1" class="lihover"><a href="#section41">Books</a></li>
                <li id ="sectionD2" class="lihover"><a href="#section42">Journals</a></li>
                <li id ="sectionD3" class="lihover"><a href="#section43">Conferences</a></li>
            </ul>
        </li>
        <li id ="sectionE" class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li id ="sectionE1" class="lihover"><a href="#section51">Attended</a></li>
                <li id ="sectionE2" class="lihover"><a href="#section52">Organised</a></li>
                <li id ="sectionE3" class="lihover"><a href="#section53">Delivered</a></li>
            </ul>
        </li>
        <li id ="sectionF" class="lihover"><a href="#section6">Co curricular activities</a></li>
        <li id ="sectionG" class="lihover"><a href="#section7">Extra curricular activities</a></li>
        <li id="sectionH" class="lihover"><a href="#section8">Awards and Achievements</a></li>
        <hr>
        <li>
            <a href = "main.php#section21"><span class="glyphicon glyphicon-arrow-left" style="float: left;padding-right:10px;"></span>Go Back</a>
        </li>
    </ul>
</nav>
            ...
            <div class="modal-body">
                <center>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <br><br>
                        <input type="submit" name="submitprofile" id ="insert_profile" value="Save Changes" style="background-color:#3C2AE6;color:white;" class="btn">
                    </form>
                </center>
            </div>
        </div>
...
<div class="container-fluid">
    <div class="col-sm-9 col-lg-10 col-md-8 col-xs-9">
        <div  id ="section1">
            <div class="col-sm-12 col-lg-12 col-md-12 col-xs-12">
                <div class="col-sm-8 col-lg-8 col-md-8 col-xs-8">
                    <h1>Personal details  <a href="EditHomePage.php#section1"><span class="glyphicon glyphicon-edit"></span></a></h1>
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <td>Date of Birth: </td><td><?php if(!($dob == '1950-01-01')) echo "<b>".dateformatChanger($dob)."</b>"; else echo "<b>-<b>";?></td>
                            </tr>
                            <tr>
        ...
        <div id = "section2">
			...
			if(!empty($sscInstitute) || !empty($hscInstitute) || !empty($bachelorsInstitute) || !empty($mastersInstitute) || !empty($phdInstitute))
			{
				...
				if(!empty($sscInstitute)){
					echo "<tr><td>1</td><td><a href='EditHomePage.php#section2'><span class='glyphicon glyphicon-edit'></span></a></td>";
					echo "<td>SSC</td><td>";
					echo "$sscInstitute";
					echo "</td><td>";
					echo "$sscPercentile";
				...
				if(!empty($hscInstitute)){
					echo "<tr><td>2</td><td><a href='EditHomePage.php#hscnew'><span class='glyphicon glyphicon-edit'></span></a></td>";
					echo "<td>HSC</td><td>";
					echo "$hscInstitute";
					echo "</td><td>";
					echo "$hscPercentile";
				...
				if(!empty($bachelorsInstitute)){
					echo "<tr><td>3</td><td><a href='EditHomePage.php#degree'><span class='glyphicon glyphicon-edit'></span></a></td>";
				...
				if(!empty($mastersInstitute)){
					echo "<tr><td>4</td><td><a href='EditHomePage.php#masters'><span class='glyphicon glyphicon-edit'></span></a></td>";
				...
				if(!empty($phdInstitute)){
					echo "<tr><td>5</td><td><a href='EditHomePage.php#phd'><span class='glyphicon glyphicon-edit'></span></a></td>";
        ...
        <div id ="section3">
            <legend><h1>Courses Taught  <a href="EditHomePage.php#section3"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h1></legend>
			<?php
			if($temp>0)
			{
				echo "<div class='table-responsive'>";
				...
				for($i=0;$i<$temp;$i++){
					...
					echo "<tr><td>".($i+1)."</td><td><a href='EditEditPage.php?parameter=".$arg."'><span class='glyphicon glyphicon-edit'>&nbsp</span></a><td><a href='EditDeletePage.php?parameter=".$arg."'><span class='glyphicon glyphicon-trash'></span></a></td></td>";
        ...
        <div id = "section4">
            <legend><h1>Projects Guided  <a href="EditHomePage.php#section4"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h1></legend>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					$arg = base64_encode( json_encode($myData) );
					echo '<tr><td>'.$projects.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td></td>';
        ...
        <div id ="section41">
            ...
            <h2>Books  <a href="EditHomePage.php#section41"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h2>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					echo '<tr><td>'.$pubbooks.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
        ...
        <div id ="section42">
            ...
            <h2>Journals <a href="EditHomePage.php#section42"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h2>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					$arg = base64_encode( json_encode($myData) );
					echo '<tr><td>'.$pubjour.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
        ...
        <div id ="section43">
            <h2>Conferences  <a href="EditHomePage.php#section43"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h2>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					$arg = base64_encode( json_encode($myData) );
					echo '<tr><td>'.$pubconf.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
					if($row["Name"] != "") echo '<td>'.$row["Name"].'</td>';else echo "<td>-</td>";
        ...
        <div id ="section51">
            ...
            <h2>STTP attended  <a href="EditHomePage.php#section51"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h2>
			<?php
        ...
        <div id ="section52">
            <legend><h2>STTP organised  <a href="EditHomePage.php#section52"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h2></legend>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					$arg = base64_encode( json_encode($myData) );
					$GLOBALS['sttp_id']=$row['sttp_id'];
					echo '<tr><td>'.$sttporganized.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
					if($row["Name"] != "") echo '<td>'.$row["Name"].'</td>';else echo "<td>-</td>";
					if($row["Type"] != "") echo '<td>'.$row["Type"].'</td>';else echo "<td>-</td>";
        ...
        <div id ="section53">
            <legend><h2>STTP delivered  <a href="EditHomePage.php#section53"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h2></legend>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					$arg = base64_encode( json_encode($myData) );
					$GLOBALS['sttp_id']=$row['sttp_id'];
					echo '<tr><td>'.$sttpdelivered.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
					if($row["Name"] != "") echo '<td>'.$row["Name"].'</td>';else echo "<td>-</td>";
        ...
        <div id ="section6">
            <legend><h1>Co-curricular Activities  <a href="EditHomePage.php#section6"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h1></legend>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					echo '<tr><td>'.$cocurr.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
					if($row["Name"] != "") echo '<td>'.$row["Name"].'</td>';else echo "<td>-</td>";
					if($row["Description"] != "") echo '<td>'.$row["Description"].'</td>';else echo "<td>-</td>";
					if($row["Type"] != "") echo '<td>'.$row["Type"].'</td>';else echo "<td>-</td>";
					if($row["Role"] != "") echo '<td>'.$row["Role"].'</td>';else echo "<td>-</td>";
        ...
        <div id ="section7">
            <legend><h1>Extra Activities  <a href="EditHomePage.php#section7"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h1></legend>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					echo '<tr><td>'.$extra.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
					if($row["Name"] != "") echo '<td>'.$row["Name"].'</td>';else echo "<td>-</td>";
					if($row["Description"] != "") echo '<td>'.$row["Description"].'</td>';else echo "<td>-</td>";
					if($row["Place"] != "") echo '<td>'.$row["Place"].'</td>';else echo "<td>-</td>";
					if($row["Role"] != "") echo '<td>'.$row["Role"].'</td>';else echo "<td>-</td>";
        ...
        <div id ="section8">
            <legend><h1>Awards and Achievements  <a href="EditHomePage.php#section8"><span id ="gly" class="glyphicon glyphicon-plus-sign"></span></a></h1></legend>
			<?php
			...
			if(mysqli_num_rows($result) > 0)
			{
				...
				while($row=mysqli_fetch_assoc($result))
				{
					...
					echo '<tr><td>'.$award.'</td><td><a href="EditEditPage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-edit">&nbsp</span></a></td><td><a href="EditDeletePage.php?parameter='.$arg.'"><span class="glyphicon glyphicon-trash"></span></a></td>';
