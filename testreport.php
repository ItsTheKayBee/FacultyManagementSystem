...
<div class="col-sm-12 col-md-12 col-lg-12 col-xs-9">
	...
	if (($datapresent == 1) && (sizeof($displayids) > 0)) {
		...
		if ($table[11] == 1) {
			echo '<th rowspan="3">Sr No.</th>';
			echo '<th rowspan="3">Employee Id</th>';
			$no_of_cols = countOnes($col12) + 1;
			echo '<th colspan="' . ($no_of_cols + 3) . '">Projects Guided</th>';
		}
		if ($table[12] == 1) {
			echo '<th rowspan="2">Sr No.</th>';
			echo '<th rowspan="2">Employee Id</th>';
				...
				if (!($row1["Name"] == '')) {
					...
					if ($table[5] == 1) {
						if ($printdone == 0) {
							...
							if ($col6[9] == 1) echo "<th rowspan='2'>Proceding Name</th>";
								...
								if ($show4 == 1) {
									...
									if ($col6[1] == 1) {
										if ($row6["Place"] == '')
											...
											echo "<tdrowspan=\"'.$multiple.'\">" . $row6["Place"] . "</td>";
									}
									if ($col6[2] == 1) {
										if ($row6["Type"] == '')
											echo "<td rowspan=\"'.$multiple.'\"> - </td>";
