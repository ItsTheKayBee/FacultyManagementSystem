...
*/
        ...
        function validateAddCourse()
        {
            ...
            {
                ctypeflag=1;
                document.getElementById("ctype").innerHTML = "* Please Enter Course Type";
        ...
        function validateAddField() {
            ...
            if(fnameflag===1 || ftypeflag===1 || ftabflag===1 || flenflag===1)
            {
                return false;
            }
        }
...
if(isset($_POST["addcourse_submit"]))
{
    ...
    if($conn->query($course_add_query)){
            ...
            <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10 well">
                ...
                <form  action="main.php" name="add_course" method="POST" onsubmit="return validateAddCourse()">
                    <div class="form-group">
                        ...
                        echo '<div class="col-sm-4 col-md-4 col-lg-4 col-xs-4"><input type="text" class="form-control " placeholder="Enter Course Type" name="coursetype" >';
                ...
                <form  action="main.php" name="add_program" method="POST" onsubmit="return validateAddProgram()">
                    <div class="form-group">
                        ...
                        if(!empty($erraddProgram)){
                            ...
                            echo '<span class="error" id ="prid">'.$erraddProgram.'</span>';
                        }
                        else {
            ...
            <div class="col-sm-10 col-lg-10 col-md-10 col-xs-10 well">
                ...
                <form  action="main.php" name="add_field" method="POST" onsubmit="return validateAddField()">
                    <div class="form-group">
                        ...
                        echo "</select>";
                        echo '<span class="error" id ="ftab"></span><br><br>';
                        ?>
                    </div>
                    <br>
                    <div class="form-group">
